...
# enable install app to oem partition (Foxpine: Disabled)
...
# declare overlay directory (Foxpine: Disabled shadow overlay)
export RK_POST_OVERLAY="overlay-luckfox-config overlay-luckfox-buildroot-init"

# Configure custom image directory (Foxpine: Using Alpine instead of Buildroot)
